...
import (
	...
	models "github.com/hostinger/fireactions/server/models"
...
// GetDefaultFlavor mocks base method.
func (m *MockStore) GetDefaultFlavor(ctx context.Context) (*models.Flavor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDefaultFlavor", ctx)
	ret0, _ := ret[0].(*models.Flavor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDefaultFlavor indicates an expected call of GetDefaultFlavor.
func (mr *MockStoreMockRecorder) GetDefaultFlavor(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDefaultFlavor", reflect.TypeOf((*MockStore)(nil).GetDefaultFlavor), ctx)
}

// GetDefaultGroup mocks base method.
func (m *MockStore) GetDefaultGroup(ctx context.Context) (*models.Group, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDefaultGroup", ctx)
	ret0, _ := ret[0].(*models.Group)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDefaultGroup indicates an expected call of GetDefaultGroup.
func (mr *MockStoreMockRecorder) GetDefaultGroup(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDefaultGroup", reflect.TypeOf((*MockStore)(nil).GetDefaultGroup), ctx)
}
...
// SetDefaultFlavor mocks base method.
func (m *MockStore) SetDefaultFlavor(ctx context.Context, name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetDefaultFlavor", ctx, name)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetDefaultFlavor indicates an expected call of SetDefaultFlavor.
func (mr *MockStoreMockRecorder) SetDefaultFlavor(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetDefaultFlavor", reflect.TypeOf((*MockStore)(nil).SetDefaultFlavor), ctx, name)
}

// SetDefaultGroup mocks base method.
func (m *MockStore) SetDefaultGroup(ctx context.Context, name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetDefaultGroup", ctx, name)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetDefaultGroup indicates an expected call of SetDefaultGroup.
func (mr *MockStoreMockRecorder) SetDefaultGroup(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetDefaultGroup", reflect.TypeOf((*MockStore)(nil).SetDefaultGroup), ctx, name)
}
